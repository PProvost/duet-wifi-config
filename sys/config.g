...
M671 X-45:340 Y10:10 S1.5   ; leadscrews at left and right of X axis
...
M208 X325 Y205 Z350 S0          ; Set axis maxima

; ##############  End stops  ##############
M574 Y2 Z1 U0 S0                ; Define active low and unused microswitches
M574 X1 S1
...
G31 X0 Y60 Z0.15 P25            ; Sensor pin offset, 25 signal threshold

; ##############  Define bed mesh grid  ##############
M557 X0:300 Y0:180 S25:20

; M376 H2                       ; Taper off the compensation over 2mm

; ##############  Heaters  ##############
M307 H1 A263.6 C114.1 D2.3 S1		; PID settings for hotend (2019-05-23)
